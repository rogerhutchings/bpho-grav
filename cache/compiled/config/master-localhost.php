...
return [
    ...
    'timestamp' => 1535917325,
    'checksum' => 'ed4a95c706e3996a26e7b58098d4c40c',
    'files' => [
        'user/config' => [
            'groups' => [
    ...
    'data' => [
        'plugins' => [
            ...
            'breadcrumbs' => [
                ...
                'icon_home' => '',
                'icon_divider_classes' => 'fal fa-angle-right',
                'link_trailing' => false
            ],
            'login' => [
                'enabled' => true,
        ...
        'system' => [
            ...
            'assets' => [
                ...
                'collections' => [
                    ...
                    'plugins' => [
                        0 => 'https://cdnjs.cloudflare.com/ajax/libs/sticky-kit/1.1.3/sticky-kit.min.js',
                        1 => 'https://cdnjs.cloudflare.com/ajax/libs/jquery.transit/0.9.12/jquery.transit.min.js',
                        2 => 'https://cdnjs.cloudflare.com/ajax/libs/jquery-throttle-debounce/1.1/jquery.ba-throttle-debounce.min.js'
                    ],
                    'fonts' => [
                        0 => 'https://fonts.googleapis.com/css?family=Nunito+Sans:200,400,600,700'
                    ]
                ]
            ],
            'errors' => [
